      ...
      <header className="bg-white shadow-sm w-full">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            {/* The FotorraLogo component itself should handle navigation or be wrapped in a Link/Button */}
            {/* Removed the duplicate "Fotorra" text button */}
            <button
              onClick={() => router.push("/")} // This button wraps the logo to make it clickable to home
              className="flex items-center gap-3" // Apply flex styles to align logo and text if you re-add text
            >
              <FotorraLogo size="md" variant="default" />
            </button>
          </div>
        </div>
      </header>
